...
func RenderBreadcrumb(match *matchmodel.MatchWithPlayers, set *setmodel.Set, game *gamemodel.Game) (template.HTML, error) {
	return breadcrumbComponent.Render(map[string]any{"Match": match, "Set": set, "Game": game})
}